...
- **0. 관리**: `00_Dashboard.md`가 Dataview/DataviewJS로 1/2/3 각 파트의 현재 목록(상단) + 전체 todo·최근 활동·프로젝트 현황(하단)을 자동 수집(집계 전용, 콘텐츠 없음). 그 외에 `Todo.md`(범용 할 일)를 둠. 상세 규칙: [[0. 관리/CLAUDE]]
