...
├── 2. 논문·프로젝트/         # 논문/프로젝트 단위 폴더 (각각 00. 개요.md, 진행 요약/ 포함)
...
- **2. 논문·프로젝트**: 논문/프로젝트마다 폴더 하나. 각 폴더는 `00. 개요.md`(목표/상태/todo), `진행 요약/`(다른 디렉터리에서 진행 중인 실제 작업을 요청 시 스냅샷 요약)로 구성. 논문 레퍼런스는 `3. Paper review/[프로젝트명] refs/`에서 관리하고 이 폴더에서는 링크만 건다. 상세 규칙: [[2. 논문·프로젝트/CLAUDE]]
